   ...
   <div style="margin-top: 5%;" class="row justify-content-center">
    ...
    <section class="selecao">
        <div class="list-group">
            ...
            <a href="#" class="list-group-item list-group-item-action">Maquiagens</a>
            <a href="#" class="list-group-item list-group-item-action">Unhas</a>
            <a href="#" class="list-group-item list-group-item-action">Sobrancelhas</a>
            <a href="#" class="list-group-item list-group-item-action">Cílios</a>
          </div>
        <div class="list-group">
            <a href="#" class="list-group-item list-group-item-action">
              Cabelos
            </a>
            <a href="#" class="list-group-item list-group-item-action">Depilações</a>
            <a href="#" class="list-group-item list-group-item-action">Massagens</a>
            <a href="#" class="list-group-item list-group-item-action">Rosto</a>
            <a href="#" class="list-group-item list-group-item-action">Barba</a>
          </div>
    </section>
